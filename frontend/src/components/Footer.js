      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/faq" className="text-gray-400 hover:text-purple-500 transition">
                  FAQ
                </a>
              </li>
              <li>
                <a href="/documentation" className="text-gray-400 hover:text-purple-500 transition">
                  Documentation
                </a>
              </li>
              <li>
                <a href="/support" className="text-gray-400 hover:text-purple-500 transition">
                  Support
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/privacy" className="text-gray-400 hover:text-purple-500 transition">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="/terms" className="text-gray-400 hover:text-purple-500 transition">
                  Terms of Service
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4 items-center">
              ...
              <a
                href="https://lesom-dynamics.vercel.app/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center text-gray-400 hover:text-purple-500 transition"
              >
                <img
                  ...
                  alt="LESOM Dynamics"
                />
                <span className="text-sm">Powered by LESOM Dynamics</span>
              </a>
            </div>
          </div>
        </div>
